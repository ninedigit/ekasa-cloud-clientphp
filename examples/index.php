...
namespace NineDigit\eKasa\Cloud\ApiClient\Examples;

use NineDigit\eKasa\Cloud\ApiClient\Client;
use NineDigit\eKasa\Cloud\ApiClient\ClientOptions;
use NineDigit\eKasa\Cloud\ApiClient\Models\QuantityDto;
use NineDigit\eKasa\Cloud\ApiClient\Models\Registrations\Receipts;
...
$receiptPrinter = new Receipts\ReceiptPrinterDto(ReceiptPrinterName::EMAIL, $printerOptions);
